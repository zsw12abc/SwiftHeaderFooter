...
class TableViewController: UITableViewController {
    ...
    var countriesinAsia = ["Japan","China","India", "Japan","China","India", "Japan","China","India"]
    var countriesInSouthAmerica = ["Argentia","Brasil","Chile","Argentia","Brasil","Chile","Argentia","Brasil","Chile"]
    ...
    override func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let  headerCell = tableView.dequeueReusableCellWithIdentifier("HeaderCell") as! CustomHeadCell
